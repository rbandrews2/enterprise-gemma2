...
(() => {
 ...
 byId("assistant-go").addEventListener("click",()=>{
  if(target==="forms-nav"||target==="schedule-nav")window.showWzosView(target.split("-")[0]);else if(target==="clock-title")window.showWzosView("clock");else window.showWzosView("orders");
