...
(() => {
 ...
 const topics={
  ...
  planning:{match:/atlas|planning|reference|source|sign|flagger|mutcd|vdot|osha|gemma|recommend/i,target:"report-nav",text:"Open Work Zone Report and choose a saved Enterprise job. Review its geometry, checklist revision and linked incident drafts, then select Let Atlas help. I can surface missing information and candidate agency passages with page references. Review their applicability and edition. Automatic sign placement is not connected in this preview. Core app guidance remains available here."},
  forms:{match:/form|pdf|document|permit|jsa|email/i,target:"forms-nav",text:"Open Forms hub to create, save and reopen an incident draft with a title, location, description and optional work-order link. General users see their own drafts; admins see their organization drafts. Other templates, official submissions, PDF and email delivery are pending."},
