...
5. Run the complete matrix in restricted staging, then keep production launch gated on roadmap items 4–8. Do not mark combined steps 2/3 complete until each row passes or Ray explicitly approves exclusions.
