...
Progress: task 1 has verified local and Cloud Shell source archives/history plus the API v17 and inference v3 build inputs. Task 2's [initial source reconciliation and prioritized repair list](V2_RECONCILIATION.md) is complete; runtime diagnosis and end-to-end cloud validation remain work for implementation/staging. Next: define the first workflow's acceptance criteria and design the locally testable service skeleton.
