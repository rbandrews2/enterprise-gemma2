...
Vehicle-inspection template rollout: image c4ff228, ready revision wzos-v2-staging-00007-8fs. Cloud browser verified DVIR selection and six initial Not checked fields. Same private IAM and ephemeral synthetic-data boundary.
